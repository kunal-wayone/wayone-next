    ...
    return (
        <section id="home" className="relative flex-col items-start p-4  my-10 rounded-[3rem] w-[98%] mx-auto overflow-hidden">
            ...
            <Image
                ...
                height={900}
                alt="Hero Background"
                className="absolute inset-0 object-contain w-full mx-auto h-auto -z-10"
            />
            ...
            <Image
                ...
                height={900}
                alt="Hero Background"
                className="absolute left-20 top-10 object-contain w-44 mx-auto h-44 -z-10"
            />
            ...
            <Image
                ...
                height={900}
                alt="Hero Background"
                className="absolute right-20 top-5 object-cover w-20 mx-auto h-44 -z-10"
            />
